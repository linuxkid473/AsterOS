/* Top-level _types.h -- real Darwin's version pulls in a "bounds safety"
 * annotation header (_bounds.h) our older clang/target don't use; this
 * is the same content minus that (and its _LIBC_SINGLE_BY_DEFAULT()
 * marker), matching this tree's other _bounds.h-stripped headers
 * (ar.h, Block.h). */
#ifndef __TYPES_H_
#define __TYPES_H_
